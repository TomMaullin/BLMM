...
def main():
    ...
    if mode == 'pSFS':
        ...
        t1 = time.time()
        est_params = divAndConq_pSFS(paramVector, inds, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        t2 = time.time()
        print(t2-t1)
...
def divAndConq_pSFS(init_params, current_inds, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params):
    ...
    # Get new params
    tmp = pSFS2D(XtX_current, XtY_current, ZtX_current, ZtY_current, ZtZ_current, XtZ_current, YtZ_current, YtY_current, YtX_current, nlevels, nparams, 1e-6, n, init_params)
    new_params = tmp[0]
    ...
    if current_dimv[0]!=1 and current_dimv[1]!=1 and current_dimv[2]!=1:
        ...
        est_params = divAndConq_pSFS(new_params, current_inds_block1, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block2, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block3, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block4, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block5, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block6, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block7, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
        est_params = divAndConq_pSFS(new_params, current_inds_block8, ZtX, ZtY, XtX, ZtZ, XtY, YtX, YtZ, XtZ, YtY, nlevels, nparams, n, est_params)
