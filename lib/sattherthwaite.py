...
def SW_lmerTest(theta3D,L,nlevels,nparams,ZtX,ZtY,XtX,ZtZ,XtY,YtX,YtZ,XtZ,YtY,n):# TODO inputs
    ...
    for i in np.arange(theta3D.shape[0]):
        ...
        # Estimate hessian
        H = nd.Hessian(llh_gamma)(gamma, ZtX_current, ZtY_current, XtX_current, ZtZ_current, XtY_current, YtX_current, YtZ_current, XtZ_current, YtY_current, nlevels, nparams)#, n, P, I, tinds, rinds, cinds)
